...
object UiTestUtils {
    ...
    fun hasNumberPickerValue(intMatcher: Matcher<Int?>): BoundedMatcher<View?, NumberPicker> {
        return object : BoundedMatcher<View?, NumberPicker>(NumberPicker::class.java) {
            ...
            public override fun matchesSafely(view: NumberPicker): Boolean {
                return intMatcher.matches(view.value)
            }
        }
    }

    fun hasNumberPickerDisplayedValue(stringMatcher: Matcher<String?>): BoundedMatcher<View?, NumberPicker> {
        return object : BoundedMatcher<View?, NumberPicker>(NumberPicker::class.java) {
            override fun describeTo(description: Description) {
            ...
            public override fun matchesSafely(view: NumberPicker): Boolean {
                val index = view.value
                val displayedValues = view.displayedValues
